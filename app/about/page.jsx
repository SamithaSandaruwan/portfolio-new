...
//       <div className="">
//         <h1 className="text-4xl font-bold text-[#61afef] pb-5" data-aos="fade-up" data-aos-duration="3000">
//         <EncryptionText text=">_About" speed={100} duration={2000} />
//         </h1>
//         <p className="max-w-[600px] text-lg text-[#abb2bf]" data-aos="fade-up" data-aos-duration="3000">
  ...
  return (
    <div className="flex flex-grow flex-row justify-between items-center p-10 space-y-6">
      <div>
        ...
        <p
          className="max-w-[600px] text-lg text-[#abb2bf]"
          data-aos="fade-up"
          data-aos-duration="1000"
          data-aos-delay="200"
        >
          ...
          passion for building high-quality applications. I specialize in Web
          Development, with experience in frontend and backend technologies,
          including React, Next.js, Node.js, and MongoDB.
        </p>
        <p
          className="max-w-[600px] text-lg text-[#abb2bf]"
          data-aos="fade-up"
          ...
          data-aos-delay="400"
        >
          Additionally, I have worked on UI/UX design, requirement engineering,
          and software testing. My goal is to create highly performant
          applications that solve real-world problems and provide users with an
          exceptional experience.
        </p>

        <div className="p-5" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
          <h3>Tech Stack💻</h3>
          <div className="flex flex-row flex-wrap gap-2">
            <img src="https://img.shields.io/badge/Java-ED8B00?style=for-the-badge&logo=java&logoColor=white" />
            <img src="https://img.shields.io/badge/javascript-%23323330.svg?style=for-the-badge&logo=javascript&logoColor=%23F7DF1E" />
